...
class RubiksCubeEnv(gym.Env):
    ...
    def step(self, action):
        ...
        self.state = self.get_state(), self.ncube.get_state_img()
        self.step_count += 1
    ...
    def reset(self):
        ...
        self.step_count = 0
        self.action_log = []
        return self.state, self.ncube.get_state_img()
    ...
    def render(self, mode='human', close=False):
        if close:
            return
        self.ncube.displayCube()

    def set_scramble(self, low, high, doScamble=True):
